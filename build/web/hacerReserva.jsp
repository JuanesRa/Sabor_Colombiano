                ...
                <div class="col-6">
                    ...
                    <div class="row">
                        <div class="col-6"> 
                            ...
                            <input type="text" class="form-control" placeholder="documento" ng-model="rc.id_cedula">
                        </div>
                        <div class="col-6"> 
                            <label>Escoja su plato</label>
                        ...
                        <div class="col-6"> 
                            ...
                            <input type="time" min="09:00" max="21:00" step="15" class="form-control" ng-model="rc.hora_reserva">
                        </div>
                        <div class="col-6"> 
